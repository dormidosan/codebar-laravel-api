...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\codebar-app-blade-breeze\public\storage' => 'string',
...
'filesystems.links.C:\\xampp\\htdocs\\codebar-app-blade-breeze\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'departments.update','departments.destroy','districts.index','districts.store','districts.show',
'districts.update','districts.destroy','municipalities.index','municipalities.store','municipalities.show',
'municipalities.update','municipalities.destroy','laboratories.index','laboratories.store','laboratories.show',
'laboratories.update','laboratories.destroy','laboratory-reagents.index','laboratory-reagents.store','laboratory-reagents.show',
'laboratory-reagents.update','laboratory-reagents.destroy','reagent-inventories.index','reagent-inventories.store','reagent-inventories.show',
'reagent-inventories.update','reagent-inventories.destroy','reagents.index','reagents.store','reagents.show',
'reagents.update','reagents.destroy','analyzer-reagent.index','analyzer-reagent.store','analyzer-reagent.show',
'analyzer-reagent.update','analyzer-reagent.destroy','analyzers.index','analyzers.store','analyzers.show',
'analyzers.update','analyzers.destroy','dashboard','profile.edit','profile.update',
...
'DB_USERNAME','DB_PASSWORD','AUTH_MODEL','SESSION_DRIVER','SESSION_LIFETIME',
